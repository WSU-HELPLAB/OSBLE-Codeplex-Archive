...
namespace OSBLE.Controllers
{
    ...
    public class CommunityController : OSBLEController
    {
        ...
        public ActionResult Edit()
        {
            ...
            Community community = db.Communities.Find(ActiveCourseUser.AbstractCourseID);
            return View(community);
        }
        ...
        public ActionResult Edit(Community community)
        {
            ...
            if (community.ID != ActiveCourseUser.AbstractCourseID)
            {
                return RedirectToAction("Index");
            }

            Community updateCommunity = (Community)ActiveCourseUser.AbstractCourse;
