...
{
    [Guid("eee1c7ba-00ea-4b22-88d7-6cb17837aaaa")]
    public sealed class CommunityToolWindow : ToolWindowPane
    {
        /// <summary>
        /// Standard constructor for the tool window.
        /// </summary>
        public CommunityToolWindow() :
            base(null)
        {
            // Set the window title reading it from the resources.
            Caption = "OSBLE+ Community";
            ...
            {
                Url = StringConstants.CommunityUrl,
                AuthKey = authKey
            };
