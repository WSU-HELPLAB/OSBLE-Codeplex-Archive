...
{
    public class TextLocation : ISpatialLocation
    {
        ...
        public TextLocation(TextSelection selection, Tuple<int, int> startLineAndIndex, Tuple<int, int> endLineAndIndex)
        {
            if (selection == null)
            {
        ...
        public TextLocation(TextPointer locationStart, TextPointer locationEnd, Tuple<int, int> startLineAndIndex, Tuple<int, int> endLineAndIndex)
        {
