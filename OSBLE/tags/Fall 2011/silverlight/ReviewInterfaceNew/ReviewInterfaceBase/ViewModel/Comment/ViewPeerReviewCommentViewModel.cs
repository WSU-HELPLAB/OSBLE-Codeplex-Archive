...
{
    public class ViewPeerReviewCommentViewModel : AbstractCommentViewModel
    {
        ...
        public ViewPeerReviewCommentViewModel(XElement xmlComment, NoteAuthor author, ILocation location)
        {
