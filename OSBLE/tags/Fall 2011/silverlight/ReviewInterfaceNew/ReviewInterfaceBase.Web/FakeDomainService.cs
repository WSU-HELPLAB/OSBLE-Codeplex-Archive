namespace ReviewInterfaceBase.Web
{
    ...
    public class FakeDomainService : DomainService
    {
        ...
        {
            return (new List<DocumentLocation>() { new DocumentLocation("save.xml", 100, "Anonymous", AuthorClassification.Student),
        ...
        public void UploadFile(string str)
        {
            ...
            StreamWriter sw = new StreamWriter("C:/Users/Mario/Documents/Work/XpsTextSelection/ReviewInterfaceBase.Web/ClientBin/save.xml");
            sw.Write(str);
            sw.Close();
        }
    }
