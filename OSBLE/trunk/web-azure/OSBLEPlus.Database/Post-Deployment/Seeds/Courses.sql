...
INSERT INTO [#AbstractCourses]
           ...
           ,[Discriminator])
VALUES
 (1, N'Advanced data structures', 0, 1, 2, N'CptS', N'223', N'Spring', N'2014', 1, 1, 0, 0, CAST(N'2015-08-29' AS DateTime), CAST(N'2015-12-18' AS DateTime), 5, 10, 24, 48, -8, 1, N'Advanced data structures, object oriented programming concepts, concurrency, and program design pri', NULL, NULL, NULL, N'Course')
,(2, N'Data Structures', 0, 1, 2, N'CptS', N'122', N'Summer', N'2014', 1, 1, 0, 0, CAST(N'2015-08-29' AS DateTime), CAST(N'2015-12-18' AS DateTime), 5, 10, 24, 48, -8, 1, N'Data Structures', NULL, NULL, NULL, N'Course')
,(3, N'OSBIDE', 0, 1, 2, N'OSBIDE', N'101', N'Spring', N'2014', 1, 1, 0, 0, CAST(N'2015-08-29' AS DateTime), CAST(N'2015-12-18' AS DateTime), 5, 10, 24, 48, -8, 1, N'Everything you ever wanted to know about OSBIDE.', NULL, NULL, NULL, N'Course')
,(4, N'Modern Structured Language', 0, 1, 2, N'CptS', N'121', N'Spring', N'2014', 1, 1, 0, 0, CAST(N'2015-08-29' AS DateTime), CAST(N'2015-12-18' AS DateTime), 5, 10, 24, 48, -8, 1, N'Formulation of problems and top-down design of programs in a modern structured language for their s', NULL, NULL, NULL, N'Course')
,(5, N'Advanced Programming Techniques', 0, 1, 2, N'CptS', N'122', N'Spring', N'2014', 1, 1, 0, 0, CAST(N'2015-08-29' AS DateTime), CAST(N'2015-12-18' AS DateTime), 5, 10, 24, 48, -8, 1, N'This course is about advanced programming techniques, data structures, recursion, sorting, searchin', NULL, NULL, NULL, N'Course')
,(6, N'Web development', 0, 1, 2, N'CptS', N'483', N'Spring', N'2014', 1, 1, 0, 0, CAST(N'2015-08-29' AS DateTime), CAST(N'2015-12-18' AS DateTime), 5, 10, 24, 48, -8, 1, N'Web development', NULL, NULL, NULL, N'Course')
...
,(9, N'Design Patterns', 0, 1, 2, N'CS', N'200', N'Fall', N'2013', 1, 1, 0, 0, CAST(N'2015-08-29' AS DateTime), CAST(N'2015-12-18' AS DateTime), 5, 10, 24, 48, -8, 1, NULL, NULL, NULL, NULL, N'Course')
