...
{
    public class OpenIdController : OSBLEController
    {
        ...
        [HttpPost, OsbleAuthorize, ValidateAntiForgeryToken]
        ...
        public ActionResult SendAssertion()
        {
            ...
            if (authReq != null && authReq.IsAuthenticated.Value)
            {
                ...
                {
                    authReq.LocalIdentifier = OpenIdProviderMvc.Models.User.GetClaimedIdentifierForUser(CurrentUser.UserName);
                }
                ...
                (anonReq != null && anonReq.IsApproved.Value))
            {
                ...
                if (claimsRequest != null)
                {
                    ...
                    {
                        claimsResponse.Email = CurrentUser.UserName;
                    }

                    if (claimsRequest.FullName != DemandLevel.NoRequest)
                    {
                        claimsResponse.FullName = CurrentUser.LastAndFirst();
                    }
        ...
        private bool UserControlsIdentifier(IAuthenticationRequest authReq)
        {
            ...
            Uri userLocalIdentifier = OpenIdProviderMvc.Models.User.GetClaimedIdentifierForUser(CurrentUser.UserName);
